...
import { renderWithAPI as render, fireEvent, waitFor, screen, generateEventTypeListWith } from '../../../test-utils';
...
runPaginatedTableTest(
    ...
    (page: number = 1, pageSize: number = 10, status: number = 200, response: EventTypeList | EventTypeError) =>
        serverGetEventTypeList(setupNock(BASE_URL), page, pageSize, '', status, response)
);
