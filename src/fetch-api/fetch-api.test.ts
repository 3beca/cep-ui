...
describe(
    ...
    () => {
        ...
        it(
            'should use GET method when RequestInfo has not method',
            async () => {
        ...
        it(
            'return an APIResponseData when GET request works fine with empty response',
            async () => {
        ...
        it(
            'return an APIResponseData when GET request works fine with json response',
            async () => {
        ...
        it(
            'return an APIResponseData when POST request works fine',
            async () => {
        ...
        it(
            'return an APIResponseData when PUT request works fine',
            async () => {
        ...
        it(
            'return an APIResponseData when DELETE request works fine',
            async () => {
        ...
        it(
            'return an APIError when request return 400',
            async () => {
                const serverResponse = {status: 400, error: 'Error400', message: 'Message Error 400'};
        ...
        it(
            'return an APIError when request return 400 without body',
            async () => {
        ...
        it(
            'return an APIError when request return 500 with body',
            async () => {
                const serverResponse = {status: 500, error: 'Error500', message: 'Message Error 500'};
        ...
        it(
            'return an APIError when request return 500 without body',
            async () => {
