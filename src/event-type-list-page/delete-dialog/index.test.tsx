...
test('Should render a dialog with empty message and snapshot', () => {
    ...
    const {container, getByLabelText, getByText, queryByLabelText, queryByText} = render(<DeleteDialog/>);
...
test('Should render a dialog with a list of EventTypes to delete and snapshot', async () => {
    ...
    const closeCallback = mockUseIconDialog();
    const {container, getByText, getByLabelText, queryByLabelText} = render(<DeleteDialog eventTypesSelecteds={eventTypeList.results}/>);
...
test('Should render a dialog with a list of EventTypes to delete and delete all items and snapshot', async () => {
    ...
    const {container, getByLabelText, getByText, queryByLabelText, getAllByLabelText} = render(<DeleteDialog eventTypesSelecteds={eventTypeList.results}  onDeleted={onDelete}/>);
...
test('Should render a dialog with error when evettypes is invalid ans snapshot', async () => {
    const closeCallback = mockUseIconDialog();
    const invalidEventType = {id: null} as unknown as EventType;
    const {container, getByLabelText, getByText, queryByLabelText} = render(<DeleteDialog eventTypesSelecteds={[invalidEventType]}/>);
