...
export type RuleFilterComparator =
...
export const isRuleFilterFieldValue = (
    value: RuleFilterFieldValue | RuleFilter | RuleFilter[] | NullOrUndefinde
...
export type WindowingGroup =
    | WindowingGroupAverage
    | WindowingGroupMax
    | WindowingGroupMin
    | WindowingGroupSum
    | WindowingGroupStdDevSamp
    | WindowingGroupStdDevPop;
